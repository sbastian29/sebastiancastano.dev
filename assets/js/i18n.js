...
const I18n = (() => {
  ...
  const T = {
    es: {
      ...
      'exp.vis.desc':'Incorporación al equipo de Data en el sector retail. Ingesta desde sistemas legacy (AS400) hacia un stack moderno, modelado analítico con dbt, gobernanza con OpenMetadata y automatización de procesos con Python, Airflow y Spark.',
      ...
      'exp.ser.role':'Ingeniero en IA e Hiperautomatización','exp.ser.date':'Mar 2025 - May 2026',
      ...
      'port.cat.data':'Data Engineering','port.cat.auto':'Automatización','port.cat.soft':'Software','port.cat.ia':'IA / Agentes','port.cat.all':'Todos','port.featured':'Destacado','port.dt.year':'Año','port.dt.area':'Área','port.dt.status':'Estado','port.dt.flow':'Recorrido del dato','port.dt.about':'Sobre el proyecto','port.dt.stack':'Stack','port.dt.close':'Cerrar',
      ...
      'port.doors.scrollHint':'Desliza para ver todos',
      'port.doors.count':'{n} proyectos',
      'port.doors.back':'Volver a las puertas',
      'port.doors.hint':'Pasa el ratón por una puerta · haz click para filtrar',
    ...
    en: {
      ...
      'exp.vis.desc':'Joined the Data team in the retail sector. Ingestion from legacy systems (AS400) into a modern stack, analytical modeling with dbt, governance with OpenMetadata and process automation with Python, Airflow and Spark.',
      ...
      'exp.ser.role':'AI & Hyperautomation Engineer','exp.ser.date':'Mar 2025 - May 2026',
      ...
      'port.cat.data':'Data Engineering','port.cat.auto':'Automation','port.cat.soft':'Software','port.cat.ia':'AI / Agents','port.cat.all':'All','port.featured':'Featured','port.dt.year':'Year','port.dt.area':'Area','port.dt.status':'Status','port.dt.flow':'Data flow','port.dt.about':'About','port.dt.stack':'Stack','port.dt.close':'Close',
      ...
      'port.doors.scrollHint':'Scroll to see all',
      'port.doors.count':'{n} projects',
      'port.doors.back':'Back to doors',
      'port.doors.hint':'Hover a door · click to filter',
